...
static void w2c_deposit_money(u64);
static u32 w2c_can_buy_candy(void);
static void w2c_buy_candy(void);
static u64 w2c_candy_pieces(void);
...
static void w2c_deposit_money(u64 w2c_p0) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  u64 w2c_j1, w2c_j2;
  w2c_i0 = 0u;
  w2c_i1 = 0u;
  w2c_j1 = i64_load((&w2c_memory), (u64)(w2c_i1) + 1024u);
  w2c_j2 = w2c_p0;
  w2c_j1 += w2c_j2;
...
static void w2c_buy_candy(void) {
  ...
  w2c_i0 = 0u;
  w2c_i1 = 0u;
  w2c_j1 = i64_load((&w2c_memory), (u64)(w2c_i1) + 1032u);
  w2c_j2 = 1ull;
  w2c_j1 += w2c_j2;
...
/* export: 'memory' */
wasm_rt_memory_t (*Z_bankZ_memory);
/* export: 'deposit_money' */
void (*Z_bankZ_deposit_money)(u64);

/* export: 'can_buy_candy' */
u32 Z_bankZ_can_buy_candy(void);

u32 Z_bankZ_can_buy_candy(void)
{
  return w2c_can_buy_candy();
}

/* export: 'buy_candy' */
void Z_bankZ_buy_candy(void)
{
  w2c_buy_candy();
}

/* export: 'candy_pieces' */
u64 (*Z_bankZ_candy_pieces)(void);

static void init_exports(void) {
  /* export: 'memory' */
  Z_bankZ_memory = (&w2c_memory);
  /* export: 'deposit_money' */
  Z_bankZ_deposit_money = (&w2c_deposit_money);
  /* export: 'candy_pieces' */
  Z_bankZ_candy_pieces = (&w2c_candy_pieces);
}
