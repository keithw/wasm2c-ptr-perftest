...
static void w2c_wasm_abort(void);

static u32 w2c___stack_pointer;

static void init_globals(void) {
  w2c___stack_pointer = 66608u;
}
...
static u32 w2c___original_main(void) {
  ...
  (*Z_bankZ_deposit_money)(w2c_j0);
  w2c_i0 = Z_bankZ_can_buy_candy();
  w2c_i0 = !(w2c_i0);
  ...
  w2c_B0:;
  w2c_i0 = w2c_l0;
  w2c_j1 = (*Z_bankZ_candy_pieces)();
  i64_store((&w2c_memory), (u64)(w2c_i0), w2c_j1);
  w2c_i0 = 1024u;
  w2c_i1 = w2c_l0;
  w2c_i0 = (*Z_envZ_printf)(w2c_i0, w2c_i1);
  w2c_i0 = w2c_l0;
  w2c_i1 = 16u;
  w2c_i0 += w2c_i1;
  w2c___stack_pointer = w2c_i0;
...
static void init_memory(void) {
  ...
  LOAD_DATA(w2c_memory, 1024u, data_segment_data_0, 33);
}
...
/* export: 'main' */
u32 (*Z_mainZ_main)(void);
/* export: 'wasm_abort' */
void (*Z_mainZ_wasm_abort)(void);

static void init_exports(void) {
  /* export: 'memory' */
  Z_mainZ_memory = (&w2c_memory);
  /* export: 'main' */
  Z_mainZ_main = (&w2c___original_main);
  /* export: 'wasm_abort' */
  Z_mainZ_wasm_abort = (&w2c_wasm_abort);
}
